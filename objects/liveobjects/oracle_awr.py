...
# CREATE FOREIGN TABLE sysdate (sysdate timestamp) SERVER orcl OPTIONS (table '(select sysdate from dual)');
    ...
    def __init__(s):
        object = {
            ...
            "tables": {
                "DBORAAWR": {
                    "request": "with %(iname)s, %(defday)s, %(interval)s, %(dbid)s, %(inum)s, %(dbname)s, %(alldeltas)s, %(snapshots)s, %(dboraawr)s select * from dboraawr" % UserObject.DEFS, 
                    "description": {"timestamp": "text", "elapsed": "int", "avgelapsed": "real", "type": "text", "sessions": "real"}
                },
                "DBORAFIL": { 
                    ...
                    "description": {"timestamp": "text", "reads": "real", "blocksperread": "real", "tablespace": "text", "file": "text", "readtime": "real", "writes": "real", "busy": "real", "busytime": "real"}
                },
                "DBORAINFO": { 
                    "request": "with %(iname)s, %(defday)s, %(interval)s, %(dbid)s, %(inum)s, %(dbname)s, %(alldeltas)s, %(snapshots)s, %(dborainfo)s select * from dborainfo" % UserObject.DEFS, 
                ...
                "DBORASGBBW": { 
                    ...
                    "description": {"timestamp": "text", "tablespace": "text", "object": "text", "owner": "text","objtype": "text", "subobject": "text", "waits": "real"}
                },
                "DBORASGCBR": { 
                    ...
                    "description": {"timestamp": "text", "tablespace": "text", "object": "text", "owner": "text","objtype": "text", "subobject": "text", "blocks": "real"}
                },
                "DBORASGCRBR": { 
                ...
                "DBORASGDBC": { 
                    ...
                    "description": {"timestamp": "text", "tablespace": "text", "object": "text", "owner": "text","objtype": "text", "subobject": "text", "changes": "real"}
                },
                "DBORASGDPR": { 
                    ...
                    "description": {"timestamp": "text", "tablespace": "text", "object": "text", "owner": "text","objtype": "text", "subobject": "text", "reads": "real"}
                },
                "DBORASGDPW": { 
                    ...
                    "description": {"timestamp": "text", "tablespace": "text", "object": "text", "owner": "text","objtype": "text", "subobject": "text", "writes": "real"}
                },
                "DBORASGGCBB": { 
                ...
                "DBORASGLR": { 
                    ...
                    "description": {"timestamp": "text", "tablespace": "text", "object": "text", "owner": "text","objtype": "text", "subobject": "text", "gets": "real"}
                },
                "DBORASGOR": { 
                ...
                "DBORASGTS": { 
                    ...
                    "description": {"timestamp": "text", "tablespace": "text", "object": "text", "owner": "text","objtype": "text", "subobject": "text", "scans": "real"}
                },
                "DBORASGUR": { 
                ...
                "DBORASQC": { 
                    ...
                    "description": {"timestamp": "text", "gets": "real", "cpu": "real", "percent": "real", "elapsed": "real", "sqlid": "text", "execs": "real"}
                },
                "DBORASQE": { 
                    ...
                    "description": {"timestamp": "text", "reads": "real", "cpu": "real", "percent": "real", "elapsed": "real", "sqlid": "text", "execs": "real"}
                },
                "DBORASQG": { 
                ...
                "DBORASQM": { 
                    ...
                    "description": {"timestamp": "text", "sharedmem": "real", "percent": "real", "sqlid": "text", "execs": "real"}
                },
                "DBORASQP": { 
                    ...
                    "description": {"timestamp": "text", "parses": "real", "percent": "real", "sqlid": "text", "execs": "real"}
                },
                "DBORASQR": { 
                ...
                "DBORASQV": { 
                    ...
                    "description": {"timestamp": "text", "versioncount": "real", "percent": "real", "sqlid": "text", "execs": "real"}
                },
                "DBORASQW": { 
                    ...
                    "description": {"timestamp": "text", "clusterwait": "real", "cpu": "real", "elapsed": "real", "sqlid": "text", "execs": "real"}
                },
                "DBORASQX": { 
                    ...
                    "description": {"timestamp": "text", "cpuperexec": "real", "rows": "real", "elapsedperexec": "real", "sqlid": "text", "execs": "real"}
                },
                "DBORASRV": { 
                    ...
                    "description": {"timestamp": "text", "reads": "real", "gets": "real", "dbtime": "real", "service": "text", "cpu": "real"}
                },
                "DBORASTA": { 
                ...
                "DBORASVW": { 
                    ...
                    "description": {"timestamp": "text", "netwaits": "real", "netwaitt": "real", "uiowaits": "real", "service": "text", "uiowaitt": "real", "admwaits": "real", "admwaitt": "real", "conwaits": "real", "conwaitt": "real"}
                },
                "DBORATBS": { 
                    ...
                    "description": {"timestamp": "text", "reads": "real", "blocksperread": "real", "tablespace": "text", "readtime": "real", "writes": "real", "busy": "real", "busytime": "real"}
                },
                "DBORATMS": { 
                ...
                "DBORAWEB": { 
                    ...
                    "description": {"timestamp": "text", "event": "text", "time": "real", "timeouts": "real", "count": "real"}
                },
                "DBORAWEC": { 
                    ...
                    "description": {"timestamp": "text", "eclass": "text", "time": "real", "timeouts": "real", "count": "real"}
                },
                "DBORAWEV": { 
